package com.countergame.hscorecounter.scorecounter.helpers
...
class HistoryAdapter(
    ...
    private val mList: List<HistoryItemViewModel>,
    ...
    class ViewHolder(itemView: View, private val onListItemClick: (position: Int) -> Unit) :
