...
class TGame constructor(
    ...
    fun pointWon(byPlayer: Int) {
        ...
        if (!finished && !tiebreak) {
            p1BreakPoint =
                !p1Serving && ((points[p1Points + 1] == "AD" && p2Points < p1Points) || points[p1Points + 1] == "W")
            p2BreakPoint =
                p1Serving && ((points[p2Points + 1] == "AD" && p1Points < p2Points) || points[p2Points + 1] == "W")
        }
