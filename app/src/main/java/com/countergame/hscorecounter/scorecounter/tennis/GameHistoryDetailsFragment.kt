...
import com.countergame.hscorecounter.databinding.FragmentGameHistoryDetailsBinding
...
class GameHistoryDetailsFragment : Fragment() {
    ...
    private fun newPointHistoryGameLayout(game: Game) {
        ...
        var pointHistoryGame =
            createPointHistoryLayout(game.servingPlayerP1, game.currentGamesP1, game.currentGamesP2)
    ...
    private fun createPointHistoryLayout(
        serve: Boolean,
        currentGamesP1: Int,
        currentGamesP2: Int
